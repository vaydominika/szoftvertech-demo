  ...
  return (
    <>
      <div 
        ...
        className="w-[25rem] h-[24rem] rounded-lg bg-gradient-to-tr from-[#8498FF] to-[#AFFFB5] p-1 relative left-[10px] transition-all duration-300 hover:scale-105 cursor-pointer"
      >
        <div className="h-[21rem] w-full mb-1">
          <img 
            src="/thumbnail.jpg"
        ...
        <h3 className="text-xl font-semibold bg-[#F4F4F4] p-1 rounded-md">
          Kurzus létrehozása
        </h3>
      </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center h-[300px] flex flex-col items-center justify-center">
                  <input
                    type="file"
                    accept="image/*"
                    className="hidden"
